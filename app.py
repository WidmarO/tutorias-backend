...
sqlalchemy_database_uri = type_database + '://' + user_database + ':' + pass_database + '@' + url_database + '/' + name_database
...
api.add_resource(Client,'/client/<string:dni>') # http://127.0.0.1:5000/user/1
